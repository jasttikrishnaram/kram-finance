...
### 3b. New: bank balance tracking

Run `supabase/3_add_balances.sql` once (SQL Editor → paste → Run) to add the balance-tracking
columns to your accounts table. Safe to run even if you're not sure whether you've run it before.
